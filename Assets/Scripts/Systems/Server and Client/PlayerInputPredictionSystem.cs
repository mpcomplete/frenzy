  ...
  public class PlayerInputPredictionSystem : SystemBase {
    ...
    protected override void OnUpdate() {
      if (!loadedAllPrefabs) {
        ...
        var fireballGhostPrefab = FindGhostPrefab(ghostPrefabs, e => EntityManager.HasComponent<NetworkFireball>(e));
        var channeledGhostPrefab = FindGhostPrefab(ghostPrefabs, e => EntityManager.HasComponent<ChanneledBeam>(e));
