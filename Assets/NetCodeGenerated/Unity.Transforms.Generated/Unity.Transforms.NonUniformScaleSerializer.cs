...
{
    [BurstCompile]
    public struct UnityTransformsNonUniformScaleGhostComponentSerializer
    {
        static UnityTransformsNonUniformScaleGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 17884505960735121,
                ExcludeFromComponentCollectionHash = 0,
                ComponentType = ComponentType.ReadWrite<Unity.Transforms.NonUniformScale>(),
                ComponentSize = UnsafeUtility.SizeOf<Unity.Transforms.NonUniformScale>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<Unity.Transforms.NonUniformScale>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<Unity.Transforms.NonUniformScale>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<Unity.Transforms.NonUniformScale>(backupData, 0);
