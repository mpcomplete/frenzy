...
{
    [BurstCompile]
    public struct TurnSpeedGhostComponentSerializer
    {
        static TurnSpeedGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 14767913548786401661,
                ExcludeFromComponentCollectionHash = 0,
                ComponentType = ComponentType.ReadWrite<TurnSpeed>(),
                ComponentSize = UnsafeUtility.SizeOf<TurnSpeed>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<TurnSpeed>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<TurnSpeed>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<TurnSpeed>(backupData, 0);
