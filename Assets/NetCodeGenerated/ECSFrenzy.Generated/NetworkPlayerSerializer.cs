...
{
    [BurstCompile]
    public struct NetworkPlayerGhostComponentSerializer
    {
        static NetworkPlayerGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 14767913548786401661,
                ExcludeFromComponentCollectionHash = 0,
                ComponentType = ComponentType.ReadWrite<NetworkPlayer>(),
                ComponentSize = UnsafeUtility.SizeOf<NetworkPlayer>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<NetworkPlayer>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<NetworkPlayer>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<NetworkPlayer>(backupData, 0);
