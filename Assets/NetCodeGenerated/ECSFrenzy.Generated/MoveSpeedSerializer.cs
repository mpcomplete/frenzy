...
{
    [BurstCompile]
    public struct MoveSpeedGhostComponentSerializer
    {
        static MoveSpeedGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 14767913548786401661,
                ExcludeFromComponentCollectionHash = 0,
                ComponentType = ComponentType.ReadWrite<MoveSpeed>(),
                ComponentSize = UnsafeUtility.SizeOf<MoveSpeed>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<MoveSpeed>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<MoveSpeed>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<MoveSpeed>(backupData, 0);
